...
SYMPTOM_SYNONYMS = {
    ...
    "chills": "chills", "shivering": "chills", "shiver": "chills", "sweating": "sweating",
    "sweats": "sweating", "night sweats": "night_sweats",

    # Head
    "headache": "headache", "head pain": "headache", "migraine": "throbbing_one_sided_headache",
    ...
    "dizziness": "dizziness", "dizzy": "dizziness", "lightheaded": "dizziness", "vertigo": "spinning_sensation",
    "spinning": "spinning_sensation",

    # Eyes & ENT
    "sore throat": "sore_throat", "throat pain": "sore_throat", "throat irritation": "sore_throat",
    "runny nose": "runny_nose", "cold": "runny_nose", "sneezing": "sneezing", "congestion": "nasal_congestion",
    "blocked nose": "nasal_congestion", "stuffy nose": "nasal_congestion",
    "sinus": "facial_pain_pressure", "sinus pain": "facial_pain_pressure", "facial pain": "facial_pain_pressure",
    "yellow eyes": "yellow_eyes_skin", "jaundice": "yellow_eyes_skin", "yellow skin": "yellow_eyes_skin",
    "loss of smell": "loss_of_taste_smell", "loss of taste": "loss_of_taste_smell", "taste lost": "loss_of_taste_smell",
    "eye pain": "pain_behind_eyes", "pain behind eyes": "pain_behind_eyes",

    # Respiratory & Cardiac
    "cough": "dry_cough", "dry cough": "dry_cough", "wet cough": "persistent_cough_with_mucus",
    ...
    "breathing problem": "shortness_of_breath", "difficulty breathing": "shortness_of_breath",
    "wheezing": "wheezing", "chest tight": "chest_tightness", "chest tightness": "chest_tightness",
    "chest pain": "chest_pressure_squeezing", "chest pressure": "chest_pressure_squeezing",
    "heart pain": "chest_pressure_squeezing", "pain radiating to arm": "pain_radiating_to_arm_neck_jaw",
    "left arm pain": "pain_radiating_to_arm_neck_jaw", "jaw pain": "pain_radiating_to_arm_neck_jaw",
    "palpitations": "palpitations_racing_heart", "racing heart": "palpitations_racing_heart",
    "fast heart": "palpitations_racing_heart", "fluttering heart": "palpitations_racing_heart",
    "cold sweat": "cold_sweating", "cold sweating": "cold_sweating",

    # Gastrointestinal
    "nausea": "nausea", "vomit": "vomiting", "vomiting": "vomiting", "throw up": "vomiting",
    "diarrhea": "watery_diarrhea", "loose motions": "watery_diarrhea", "watery stool": "watery_diarrhea",
    "stomach pain": "stomach_pain", "stomach ache": "stomach_pain", "belly pain": "stomach_pain",
    "abdominal pain": "stomach_pain", "stomach cramp": "abdominal_cramps",
    ...
    "gerd": "heartburn_burning_chest", "burning stomach": "burning_stomach_pain_between_meals",
    "bloating": "bloating", "gas": "bloating", "dark urine": "dark_urine", "pale stool": "pale_stools",
    "loss of appetite": "loss_of_appetite", "no appetite": "loss_of_appetite",

    # Endocrine & Systemic
    "fatigue": "fatigue", "tired": "fatigue", "weakness": "fatigue", "exhaustion": "fatigue",
    ...
    "joint pain": "joint_pain", "knee pain": "joint_pain", "stiff joints": "joint_stiffness_in_morning_under_30min",
    "body pain": "muscle_pain", "body ache": "severe_body_ache", "muscle ache": "muscle_pain",
